...
<template>
  <div class="mt-16 border-t border-gray-100 dark:border-gray-800 pt-10">
    <p class="text-xs font-semibold uppercase tracking-widest text-gray-400 dark:text-gray-500 text-center mb-6">🎲 Fun Time</p>
